...
public class UserPushNotificationMapper {
    ...
    public static UserPushNotificationEntity toEntity(UserPushNotification userPushNotificationDomain) {
    ...
    public static UserPushNotification toDomain(UserPushNotificationEntity userPushNotificationEntity) {
